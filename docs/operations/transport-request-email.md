...
The email includes the job, requester name and email, department, creation and required dates, movement type, priority, source, origin, destination, description, notes, requested vehicles and available space. Dates use the job timezone, falling back to Europe/Madrid. The action link opens the Logistics page.
