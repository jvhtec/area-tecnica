...
```bash
fonttools varLib.instancer "NotoSans-VariableFont_wdth,wght.ttf" \
  wght=400 wdth=100 --output "NotoSansPdf-Regular.ttf"
```
...
```bash
fonttools subset "NotoSansPdf-Regular.ttf" \
