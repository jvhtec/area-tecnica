...
const ENGLISH_LABELS: ConsumosLabels = {
  ...
  deleteAction: "Delete",
  fohSchuko:
    "16A female Schuko supply required at FoH (auxiliary; excluded from totals)",
  supply: "Supply",
  ...
  currentPerPhase: "Line current:",
  current: "Current:",
  pduTypeLabel: "PDU Type:",
  positionLabel: "Position:",
  hoistNote: "Additional hoist supply required: CEE32A 3P+N+G (excluded from totals)",
  notAvailable: "N/A",
  ...
  toastInvalidCalculation: "Enter positive quantity, watts, voltage, and PF (up to 1).",
...
const SPANISH_LABELS: ConsumosLabels = {
  ...
  fohSchuko:
    "Se requiere suministro de 16A en schuko hembra en FoH (auxiliar; excluido de los totales)",
  supply: "Suministro",
  ...
  apparentPower: "Potencia Aparente:",
  currentPerPhase: "Corriente de línea:",
  current: "Corriente:",
  pduTypeLabel: "Tipo de PDU:",
  positionLabel: "Posición:",
  hoistNote: "Se requiere suministro adicional para motor: CEE32A 3P+N+G (excluido de los totales)",
  notAvailable: "N/A",
  savedSetLoaded: (count) =>
  ...
  toastInvalidCalculation: "Introduce cantidad, vatios, voltaje y PF positivos (PF hasta 1).",
