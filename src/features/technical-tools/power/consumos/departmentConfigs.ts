...
const ENGLISH_LABELS: ConsumosLabels = {
  ...
  pduOverridePlaceholder: "Use recommended PDU type",
  customPduOption: "Custom PDU type",
  customPdu: "Custom PDU Type",
  customPduPlaceholder: "Enter custom PDU type",
  hoistCheckbox: "Requires additional hoist power (CEE32A 3P+N+G)",
  colQuantity: "Quantity",
  colLineName: "Name",
  lineNamePlaceholder: "Optional line name",
  colComponent: "Component",
  componentPlaceholder: "Select component",
  componentSearchPlaceholder: "Search component...",
  componentEmpty: "No components found.",
...
const SPANISH_LABELS: ConsumosLabels = {
  ...
  pduOverride: "Anulación del Tipo de PDU",
  pduOverridePlaceholder: "Usar el tipo de PDU recomendado",
  customPduOption: "Tipo de PDU personalizado",
  customPdu: "Tipo de PDU Personalizado",
  customPduPlaceholder: "Ingrese un tipo de PDU personalizado",
  hoistCheckbox: "Requiere Potencia Adicional para Motor (CEE32A 3P+N+G)",
  ...
  componentEmpty: "No se encontraron componentes.",
