 ...
 */
export const DRYHIRE_PARENT_IDS = {
  sound: {
...
/**
 * Responsible person IDs by department
 */
export const RESPONSIBLE_PERSON_IDS = {
...
/**
 * Department suffixes used in document numbers
 */
