...
it("delegates dry-hire identity to the server-owned job operation", async () => {
  await createAllFoldersForJob({ id: "dryhire-1", job_type: "dryhire", title: "Dry Hire", start_time: "2026-01-01T10:00:00Z", end_time: "2026-01-01T20:00:00Z", timezone: "Europe/Madrid" }, "ignored", "ignored", "ignored");
...
it("surfaces server reconciliation failures", async () => {
  ...
  await expect(createAllFoldersForJob({ id: "dryhire-2", job_type: "dryhire", title: "Dry Hire", start_time: "2026-01-01T10:00:00Z", end_time: "2026-01-01T20:00:00Z" }, "ignored", "ignored", "ignored")).rejects.toThrow("Reconciliation required");
});
