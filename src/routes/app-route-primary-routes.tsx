...
export const primaryAppRoutes: readonly AppRoute[] = [
  ...
  {
    id: "conductorDashboard",
    path: "/conductor",
    component: ConductorDashboard,
    layout: "app",
    access: "conductor",
    subscriptions: "conductor",
    breadcrumb: { label: "Mis transportes" },
    nav: {
      id: "conductor-dashboard",
      label: "Mis transportes",
      mobileLabel: "Transportes",
      shortcut: { id: "nav-conductor-dashboard", icon: "Truck" },
    },
  },
  {
