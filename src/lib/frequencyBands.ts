...
export const WIRELESS_BANDS_EU: Record<string, FrequencyBandOption[]> = {
  ...
  [normalizeModelKey('Sennheiser EW-D Series')]: [
    option('Q1-6', 470.2, 526),
    option('R1-6', 520, 576),
    option('R4-9', 552, 607.8),
    option('S1-7', 606.2, 662),
    option('S4-7', 630, 662),
    option('S7-10', 662, 693.8),
    option('T1/7-1', 694.5, 702.7),
    option('T1/7-2', 748.3, 757.7),
    option('T12', 806.125, 809.75),
    option('T13-14', 819.2, 823),
    option('U1/5-1', 823.2, 831.8),
    option('U1/5-2', 863.2, 864.8),
    option('V3-4', 925.2, 937.3),
    option('Y1-3', 1785.2, 1799.8),
  ],
  [normalizeModelKey('Sennheiser EW-DX Series')]: [
    option('Q1-9', 470.2, 550),
    option('R1-9', 520, 607.8),
    option('S1-10', 606.2, 693.8),
    option('S2-10', 614.2, 693.8),
    option('S4-10', 630, 693.8),
    option('U1/5-1', 823.2, 831.8),
    option('U1/5-2', 863.2, 864.8),
    option('V3-4', 925.2, 937.3),
    option('V5-7-1', 941.7, 951.8),
    option('V5-7-2', 953.05, 956.05),
    option('V5-7-3', 956.65, 959.65),
    option('W5-6-1', 1240.1, 1251.875),
    option('W5-6-2', 1253.125, 1259.9),
    option('Y1-3', 1785.2, 1799.8),
  ],
};
