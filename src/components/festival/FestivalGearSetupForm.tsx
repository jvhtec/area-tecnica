        ...
        if (setupData) {
          ...
          if (!isPrimaryStage) {
            ...
            setSetup({
              ...
              monitors_enabled: (setupData.available_monitors ?? 0) > 0,
              ...
              infra_cat6: (setupData.available_cat6_runs ?? 0) > 0,
              infra_cat6_quantity: setupData.available_cat6_runs || 0,
              infra_hma: (setupData.available_hma_runs ?? 0) > 0,
              infra_hma_quantity: setupData.available_hma_runs || 0,
              infra_coax: (setupData.available_coax_runs ?? 0) > 0,
              infra_coax_quantity: setupData.available_coax_runs || 0,
              infra_opticalcon_duo: (setupData.available_opticalcon_duo_runs ?? 0) > 0,
