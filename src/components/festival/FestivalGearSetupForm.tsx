...
export const FestivalGearSetupForm = ({
          ...
          if (!isPrimaryStage) {
            ...
            if (stageSetupData) {
              ...
              setSetup({
                ...
                foh_waves_models: stageSetupData.foh_waves_models || [],
                foh_outboard: stageSetupData.foh_outboard || "",
                mon_waves_models: stageSetupData.mon_waves_models || [],
                mon_outboard: stageSetupData.mon_outboard || "",
            ...
            setSetup({
              ...
              foh_waves_models: setupData.foh_waves_models || [],
              foh_outboard: setupData.foh_outboard || "",
              mon_waves_models: setupData.mon_waves_models || [],
              mon_outboard: setupData.mon_outboard || "",
    ...
    try {
      ...
      if (isPrimaryStage) {
        const setupPayload = {
          ...
          foh_waves_models: setup.foh_waves_models,
          foh_outboard: setup.foh_outboard,
          mon_waves_models: setup.mon_waves_models,
  ...
  const getCompatibleFormData = () => ({
    ...
    foh_waves_models: [] as string[],
    foh_outboard: "",
    foh_waves_provided_by: "festival",
    mon_waves_models: [] as string[],
    mon_outboard: "",
