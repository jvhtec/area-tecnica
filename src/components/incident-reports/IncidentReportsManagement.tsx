...
import { PublicIncidentReportsTriage } from "./PublicIncidentReportsTriage";
  ...
  return (
    <Tabs defaultValue="documents" className="space-y-6">
      <TabsList className="flex flex-wrap gap-2">
        <TabsTrigger value="documents">Reportes internos</TabsTrigger>
        <TabsTrigger value="public">Reportes públicos</TabsTrigger>
      </TabsList>
