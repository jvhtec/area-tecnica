...
/**
 * Render the settings UI for viewing, editing, and saving the current user's Flex API key.
 *
 * Saving persists the trimmed key to the user's `profiles.flex_api_key`, clears the Flex token cache so changes take effect immediately, and displays success or error toasts.
 *
 * @returns A JSX element containing the API key input, explanatory text, and a save button; returns `null` while the initial key is being loaded.
 */
