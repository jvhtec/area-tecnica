...
const soundComponentDatabase = [
  { id: 1, name: 'AMPLIFICADOR LA12X', watts: 3600 },
  { id: 2, name: 'AMPLIFICADOR LA4X', watts: 2500 },
  { id: 3, name: 'AMPLIFICADOR LA7.16i', watts: 1700 },
  { id: 4, name: 'SUBWOOFER KS28', watts: 4000 },
  { id: 5, name: 'LINE ARRAY K2', watts: 1800 },
  { id: 6, name: 'LINE ARRAY K1', watts: 2500 },
  { id: 7, name: 'FILL KARA II', watts: 1000 },
  { id: 8, name: 'MONITOR KIVA', watts: 500 },
  { id: 9, name: 'SUBWOOFER K1-SB', watts: 2000 },
  { id: 10, name: 'CENTRAL DE MOTOR CMX32', watts: 150 },
  { id: 11, name: 'MOTOR CHAINMASTER 2T', watts: 2000 },
  { id: 12, name: 'MOTOR CHAINMASTER 1T', watts: 1500 },
  { id: 13, name: 'MOTOR CHAINMASTER 750KG', watts: 1000 },
  { id: 14, name: 'MOTOR CHAINMASTER 500KG', watts: 800 },
  { id: 15, name: 'POLIPASTO MANUAL 1T', watts: 0 }
];
...
const ConsumosTool: React.FC = () => {
  ...
  const generateTable = () => {
    ...
    if (selectedJobId || isOverrideMode) {
