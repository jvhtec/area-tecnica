-- Fix compute_timesheet_amount_2025: Remove invalid jsonb subtraction operator
...
BEGIN
  ...
  -- 8) Build breakdown with properly filtered notes array
  breakdown := jsonb_build_object(
    ...
    'notes', (
      ...
      FROM (
        SELECT 'Rounding: next hour starts at ≥ 30 minutes'::text AS note
        UNION ALL
        SELECT CASE 
