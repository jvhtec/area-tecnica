-- Fix invalid enum value 'cancelled' to use correct Spanish enum 'Cancelado'
-- The compute_tour_job_rate_quote_2025 function was using 'cancelled' and 'deleted'
-- but the job_status enum uses Spanish values: 'Cancelado', 'Completado', 'Confirmado', 'Tentativa'
...
BEGIN
  ...
  IF team_member THEN
    ...
    BEGIN
      ...
      -- FIX: Use 'Cancelado' instead of 'cancelled'
