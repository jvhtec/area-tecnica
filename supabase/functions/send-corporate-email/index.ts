...
function wrapInCorporateTemplate(options: CorporateTemplateOptions): string {
  ...
  const COMPANY_LOGO_URL =
    ...
    (supabaseUrl
      ? `${supabaseUrl}/storage/v1/object/public/company-assets/sectorlogow.png`
      : "");
  const AT_LOGO_URL =
    Deno.env.get("AT_LOGO_URL") ||
    (supabaseUrl
      ? `${supabaseUrl}/storage/v1/object/public/company-assets/area-tecnica-logo.png`
      : "");
