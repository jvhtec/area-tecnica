-- Complete tour rate function with:
-- 1. Correct Spanish enum values ('Cancelado' not 'cancelled')
-- 2. Tour multiplier override flag support
-- 3. House tech tour base rates (tour_base_responsable_eur and tour_base_other_eur)
