-- Grant task-focused permissions for the Oscar role.
-- Scope:
--   1) Oscar can access pending tasks view entries assigned to Oscar users.
--   2) Oscar can read all task rows and create tasks in any department.
--   3) Oscar can update only tasks they created or are assigned to.
