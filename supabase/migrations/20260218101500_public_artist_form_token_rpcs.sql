-- Public token-based access for artist requirement forms.
-- This keeps table RLS strict while allowing anonymous artists to load/submit
-- only the form addressed by their unique token.
