-- Reject a transport plan whose unload precedes its load.
--
-- TransportRequestPlanningDialog validates this in the form, but schedule_transport_request
-- is the trust boundary: it is a granted RPC any authenticated admin/management caller can
-- invoke directly, and it writes the calendar events other surfaces read.
