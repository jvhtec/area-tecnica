...
-- 2) normalize updated_at/submitted_at to UTC for consistency
-- 3) return structured JSON on cast/validation errors
-- 4) treat explicit JSON null arrays as SQL NULL for fallback/default behavior
...
begin
  ...
  begin
    ...
    set
      ...
      extras_wired = coalesce(p_form_data->>'extras_wired', extras_wired),
