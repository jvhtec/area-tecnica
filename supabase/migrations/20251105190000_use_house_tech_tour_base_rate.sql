-- Update compute_tour_job_rate_quote_2025 to use tour_base_day_eur for house techs
-- When house techs are assigned to tour dates, use their tour-specific rate if available
...
BEGIN
  ...
  -- Base rate lookup
  IF house THEN
    -- UPDATED: For tour dates, use tour-specific rates based on category
