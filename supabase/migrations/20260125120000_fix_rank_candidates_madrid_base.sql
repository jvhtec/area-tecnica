-- Fix rank_staffing_candidates proximity calculation:
-- - Avoid joining locations.venue_id (column does not exist)
-- - Compute distance relative to Madrid base (40.4168, -3.7038)
