-- Update compute_timesheet_amount_2025 to handle evento job type
-- Evento jobs should always use 12 hours and never calculate overtime
...
'Calculates timesheet amounts based on rate cards. For evento jobs, always uses 12 hours at the 12-hour rate with no overtime, regardless of actual worked hours.';
